    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-3">
      <div class="row align-items-center px-3">
        <div class="col-lg-6 text-center text-lg-left">
          ...
          <h4 class="text-white mb-4 mt-5 mt-lg-0">প্লে-গ্রুপ থেকে দশম শ্রেণী পর্যন্ত</h4>
          <h1 class="display-3 font-weight-bold text-white mb-5">
            <!-- New Approach to Smart Education -->
            স্মার্ট শিক্ষার নতুন পদ্ধতি
          </h1>

          <h4 class="mb-4 mt-5 mt-lg-0">একটি আধুনিক উচ্চমানের জাতি ধর্ম-বর্ণ নির্বিশেষে আবাসিক ও অনাবাসিক শিক্ষা প্রতিষ্ঠান</h4>

          <!-- <img src="img/admision_on_going.png" width=200 style="margin-top: 50px;"> -->
            <!-- <h4 class="blink">From Play Group to 10th Class</h4>  -->
